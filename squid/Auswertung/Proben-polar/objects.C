...
void objects()
  ...
  vector<string> objects;
     objects.push_back("bolzen");// freq.push_back(50.0);
     objects.push_back("gold2");// freq.push_back(50.0);
     objects.push_back("isekey");// freq.push_back(50.0);
     objects.push_back("kronkorken");// freq.push_back(50.0);
     objects.push_back("magnetspan-senkr");// freq.push_back(50.0);
     objects.push_back("zylinder");// freq.push_back(50.0);
     objects.push_back("eisenspan-par");// freq.push_back(50.0);
     objects.push_back("gold");// freq.push_back(50.0);
     objects.push_back("kaffeekey");// freq.push_back(50.0);
     objects.push_back("magnetspan-45");// freq.push_back(50.0);
     objects.push_back("eisenspan-senk");// freq.push_back(45.0);
     objects.push_back("ipodaus");// freq.push_back(50.0);
     objects.push_back("kronkorken2");// freq.push_back(50.0);
     objects.push_back("magnetspan-par");// freq.push_back(50.0);
     objects.push_back("stein");// freq.push_back(50.0);
