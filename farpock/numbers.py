...
def n_to_latex(number, precission, base):
  return r'' + str(round(number/(10**base), precission))
...
def n_e_to_latex(number, error, precission, base):
  return r'$(' + str(round(number/(10**base), precission)) + r' \pm ' + str(round(error/(10**base), precission)) + r')$'
