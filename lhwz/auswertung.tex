...
\begin{figure}[H]
 \centering \includegraphics[width=0.99\linewidth]{Messwerte/plots/U238.png}
...
\begin{figure}[H]
 \centering \includegraphics[width=0.99\linewidth]{Messwerte/plots/Sm147_plateau.png}
...
\begin{figure}[H]
 ...
 \caption{\atom{40}{}{K}-Plateau - Zweite Messung}
\end{figure}
...
Da uns die Untergrundmessung auf Grund der geschilderten Probleme misslang und die lange Untergrundmessung über das Wochenende den Bereich des $\beta$-Plateaus nicht abdeckt, haben wir eine Extrapolation vorgenommen. Die Daten der Untergrundmessung stützen diese allerdings nur sehr begrenzt ( $\chi^2/DoF = 578.182$). Durch die Extrapolation erhalten wir eine Untergrundzählrate von $ n_{Untergrund} = 0.502 Bq$ für die Messungen bei $U = 3600V$.
