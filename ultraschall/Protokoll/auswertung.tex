...
Für die Ermittlung der Schallwellenlänge haben wir die Messung bei $ U = 9.69 V$ und $f = 2109.195 kHz $ verwendet. Dazu haben wir die Zeit $t$ der Maxima gegen ihre Ordnung aufgetragen. Aus der Steigung $a$ einer Ausgleichsgeraden erhalten wir über den Zusammenhang $ \sin \alpha = \frac{m \lambda}{\lambda^{*}} = \beta \frac{\Delta t}{2} $ die Schallwellenlänge $ \lambda^* $

Steigung und Achsenabschnitt der Ausgleichsgeraden:
a               = 2.07162e-05      +/- 9.1e-08      (0.4392%)
b               = 9.85261e-05      +/- 1.966e-07    (0.1995%)
